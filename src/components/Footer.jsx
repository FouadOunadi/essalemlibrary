...
export default function Footer() {
  return (
    <footer className="bg-stone-950 text-white p-8" dir="rtl">
      <div className="w-full mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        <div >
          <h3 className="text-lg font-semibold mb-4">مكتبة السلام</h3>
          <p className="text-gray-300 md:max-w-[15rem]">مكتبتك الشاملة لجميع مستلزمات المدرسة والمكتبة والخدمات التعليمية</p>
        </div>
        ...
        <div>
          ...
          <div className="space-y-3">
            <a href="tel:+213123456789" className="flex items-center text-gray-300 hover:text-yellow-300">
              <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
              </svg>
              0658744115 / 0668674585
            </a>
              ...
              essalemlibrary@gmail.com
            </a>
            
            <a href='https://instagram.com/essalemlibrary' target='_blank' rel="noopener noreferrer"
              className="flex items-center text-gray-300 hover:text-yellow-300">
      ...
      <div className="border-t border-gray-800 mt-8 pt-6 max-w-7xl mx-auto text-center">
        <p className="text-gray-400 text-sm">&copy; {new Date().getFullYear()} مكتبة السلام. جميع الحقوق محفوظة.</p>
      </div>
    </footer>
  );
}